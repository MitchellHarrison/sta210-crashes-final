...
`weekend_weekday`: a binary variable corresponding to whether a MVC occurred during the weekend or the w
...
**Our primary research concern is determining which characteristics of the timing and participants involved make a motor vehicle collision (MVC) more likely to involve casualties.**
