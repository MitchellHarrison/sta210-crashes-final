...
# Discussion
Our primary research concern is determining which characteristics of a MVC's timing and participants involved make casualties more likely. For the following summary, we will consider p-values that are less than 0.05 to be significant.
